...
Hoy corresponde aprovechar su avance para un trabajo de *sketching* que se recomienda **dividir en 3 etapas**, que adapta una dinámica de diseño colaborativo conocida como *Design Studio*, la que se describe en el libro [Lean UX de Jeff Gothelf (pp.37-41)](https://drive.google.com/file/d/1sjTOzb0sRthTwPaNZF5wDJ4KkEsgChAc/view?usp=sharing). Por partes, corresponde: 

**1ro.** Delimitar el desafío grupal: ¿Qué informar mediante gráfica?

**2do.** Cada integrante del grupo debe desarrollar un *sketch* respondiendo al desafío delimitado:
...
**3ro.** Atendiendo a la segunda evaluación cruzada, el equipo estructura un último *sketch*, esta vez grupal. Puede demorar cerca de 30 minutos en su refinamiento. 
...
Ideal es que el *sketch* final se confunda con uno producido para una infografía que ha de ser publicada por el South China Morning Post o en Reuters Graphics, y bajo ninguna circunstancia se confunda con el *sketch* de una *landing page*:
